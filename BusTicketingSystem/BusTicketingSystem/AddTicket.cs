...
namespace BusTicketingSystem
{
    public partial class AddTicket : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Trip: " + cmpsTrip.Text, new Font("Centuary", 12), Brushes.Black, new Point(10, 100));
            e.Graphics.DrawString("Bus Type: " + cbtickBusType.Text, new Font("Centuary", 12), Brushes.Black, new Point(10, 120));
            e.Graphics.DrawString("Bus No.: " + txttickBusNo, new Font("Centuary", 12), Brushes.Black, new Point(10, 140));
